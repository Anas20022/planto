          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                height: 90,
                decoration: BoxDecoration(
                  // color: isSelected ? Color(0xFF438853) :  Provider.of<ModeProvider>(context).darkModeEnable?Colors.white:Colors.black, // تغيير اللون عند التحديد
              ...
              Text(
                ...
                style: TextStyle(
                  fontSize: 12,
                  color: isSelected ? Provider.of<ModeProvider>(context).darkModeEnable?Colors.white:Colors.black : Color(0xFF438853), // تغيير النص حسب التحديد
                  fontWeight: FontWeight.bold,
                ),
